				...
				<div class="user-option">
					...
					<div class="user-option-box hidden">
						<nav class="hidden">
							...
							<button class="logout-button user-service-nav" onclick="location.href='https://kauth.kakao.com/oauth/logout?client_id={bcf283702c88974c445ca041bb3d6ad6}&logout_redirect_uri={http://localhost:8000/login/oauth2/code/kakao}';">
								로그아웃
